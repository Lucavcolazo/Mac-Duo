...
> [!NOTE]
> This is a personal copy of [sumimakito/Mac-Duo](https://github.com/sumimakito/Mac-Duo), kept under its original [Apache License 2.0](LICENSE) (see [NOTICE](NOTICE)). All credit for the original design and implementation goes to Makito. If you find it helpful, consider [sponsoring the original author](https://github.com/sponsors/sumimakito).
...
No prebuilt downloads here — build it yourself with the instructions below.
